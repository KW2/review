...
public class ListViewBtnAdapter extends ArrayAdapter<ListViewBtnItem> implements View.OnClickListener {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final TextView textTextView = (TextView) convertView.findViewById(R.id.cst_t1);
        ...
        // 수정 버튼 클릭시 수정 작업
        Button update_btn = (Button) convertView.findViewById(R.id.cst_b1);
        ...
        Button delete_btn = (Button) convertView.findViewById(R.id.cst_b2);
